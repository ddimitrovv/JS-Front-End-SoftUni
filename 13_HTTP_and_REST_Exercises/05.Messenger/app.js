function attachEvents() {
    ...
    const name = document.querySelector('#controls > div:nth-child(1) > input[type=text]');
    const message = document.querySelector('#controls > div:nth-child(2) > input[type=text]')
